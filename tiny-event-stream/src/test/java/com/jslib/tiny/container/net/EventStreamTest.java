...
public class EventStreamTest {
	...
	public void loop_ShutdownEvent() throws InterruptedException {
		Event event = Classes.newInstance("com.jslib.tiny.container.net.EventStream$ShutdownEvent");
	...
	public void close() throws InterruptedException {
		...
		Class<? extends Event> eventClass = Classes.forName("com.jslib.tiny.container.net.EventStream$ShutdownEvent");
