...
public class RestServlet extends AppServlet {
	 ...
	 */
	private final Map<String, IManagedMethod> restMethods = new HashMap<>();
	 ...
	 * {@link #key(IManagedMethod)} based on managed class and REST method request paths and is paired with retrieval key -
