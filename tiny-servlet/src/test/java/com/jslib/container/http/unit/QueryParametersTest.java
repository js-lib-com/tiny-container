...
public class QueryParametersTest {
	...
	private static Object getQueryParametersParser(String queryString) {
		return Classes.newInstance("com.jslib.container.http.encoder.QueryParametersParser", queryString);
	}

	private static Object getQueryParametersParser(InputStream inputStream) {
		return Classes.newInstance("com.jslib.container.http.encoder.QueryParametersParser", inputStream);
	}

	private static Class getQueryParametersParserClass() {
		return Classes.forName("com.jslib.container.http.encoder.QueryParametersParser");
	}
