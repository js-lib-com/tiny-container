...
public class StreamsTest {
	...
	public void streamFactory_Constructor() throws Exception {
		Class<?> clazz = Classes.forName("com.jslib.container.http.encoder.StreamFactory");
	...
	public void argumentsReader_read_EmptyTypes() throws Exception {
		ArgumentsReader reader = Classes.newInstance("com.jslib.container.http.encoder.StreamArgumentsReader");
