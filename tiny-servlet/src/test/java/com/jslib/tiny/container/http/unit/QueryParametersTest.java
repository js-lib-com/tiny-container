...
public class QueryParametersTest {
	 ...
	 * converter test is carry out by converter unit tests. See com.jslib.web.QueryParametersParser#getArguments(Type[]) for arguments
	 * logic description.
	 */
	@Test
	...
	private static Object getQueryParametersParser(String queryString) {
		return Classes.newInstance("com.jslib.tiny.container.http.encoder.QueryParametersParser", queryString);
	}

	private static Object getQueryParametersParser(InputStream inputStream) {
		return Classes.newInstance("com.jslib.tiny.container.http.encoder.QueryParametersParser", inputStream);
	}

	private static Class getQueryParametersParserClass() {
		return Classes.forName("com.jslib.tiny.container.http.encoder.QueryParametersParser");
	}
