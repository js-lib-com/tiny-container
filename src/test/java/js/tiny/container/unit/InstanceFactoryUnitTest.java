...
public class InstanceFactoryUnitTest {
		...
		Thread.currentThread().setContextClassLoader(new ClassLoader() {
			...
			public Enumeration<URL> getResources(String name) throws IOException {
				if (name.contains("$Human")) {
					name = "js/tiny/container/unit/human";
				}
	...
	public void remoteInstanceFactory_RemoteFactoriesProvider() throws Exception {
		...
		Thread.currentThread().setContextClassLoader(new ClassLoader() {
			...
			public Enumeration<URL> getResources(String name) throws IOException {
				if (name.contains("RemoteFactoryProvider")) {
					name = "js/tiny/container/unit/remote-factory-provider";
				}
				return super.getResources(name);
			}
		});
		try {
			...
			assertEquals("js.tiny.container.unit.InstanceFactoryUnitTest$MockRemoteFactory", remoteFactories.get("mock").getClass().getName());
		} finally {
			Thread.currentThread().setContextClassLoader(contextClassLoader);
		}
	}
