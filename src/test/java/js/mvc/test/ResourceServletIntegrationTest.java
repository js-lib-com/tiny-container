...
public class ResourceServletIntegrationTest {
	private static final String DESCRIPTOR = "" + //
			...
			"<test-config>" + //
			"	<managed-classes>" + //
			"		<app interface='js.core.App' class='js.mvc.test.ResourceServletIntegrationTest$MockApp' />" + //
			"		<controller class='js.mvc.test.ResourceServletIntegrationTest$DefaultController' />" + //
