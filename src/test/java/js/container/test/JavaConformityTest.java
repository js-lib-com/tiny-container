...
public class JavaConformityTest {
	...
	public void staticInitialization() throws Throwable {
		...
		Class<?> clsA = Class.forName("js.container.test.JavaConformityTest$TestClass", true, loader1);
		Class<?> clsB = Class.forName("js.container.test.JavaConformityTest$TestClass", true, loader2);
