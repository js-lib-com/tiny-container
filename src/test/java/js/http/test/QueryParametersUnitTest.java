...
public class QueryParametersUnitTest {
	...
	private static Object getQueryParametersParser(String queryString) {
		return Classes.newInstance("js.http.encoder.QueryParametersParser", queryString);
	}

	private static Object getQueryParametersParser(InputStream inputStream) {
		return Classes.newInstance("js.http.encoder.QueryParametersParser", inputStream);
	}

	private static Class getQueryParametersParserClass() {
		return Classes.forName("js.http.encoder.QueryParametersParser");
	}
