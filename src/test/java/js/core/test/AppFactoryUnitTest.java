...
public class AppFactoryUnitTest {
	...
	public void getInstance_ConstructorArguments() throws Exception {
		String descriptor = "<person class='js.core.test.AppFactoryUnitTest$Person' scope='LOCAL' />";
		AppFactory factory = TestContext.start(config(descriptor));
		Person person = factory.getInstance(Person.class, "John Doe");
	...
	public void getInstance_LocalScope() throws Exception {
		String descriptor = "<car class='js.core.test.AppFactoryUnitTest$Car' scope='LOCAL' />";
		AppFactory factory = TestContext.start(config(descriptor));
	...
	public void getInstance_PojoType() throws Exception {
		String descriptor = "<car class='js.core.test.AppFactoryUnitTest$Car' type='POJO' />";
		AppFactory factory = TestContext.start(config(descriptor));
	...
	public void getInstance_ContainerType() throws Exception {
		String descriptor = "<car interface='js.core.test.AppFactoryUnitTest$Product' class='js.core.test.AppFactoryUnitTest$Car' type='PROXY' />";
		AppFactory factory = TestContext.start(config(descriptor));
	...
	public void getInstance_ServiceType() throws Exception {
		...
		Thread.currentThread().setContextClassLoader(new ClassLoader() {
			...
			public Enumeration<URL> getResources(String name) throws IOException {
				if (name.contains("$Product")) {
					name = "js/core/test/AppFactoryUnitTest$Product";
				}
		...
		try {
			String descriptor = "<product interface='js.core.test.AppFactoryUnitTest$Product' type='SERVICE' />";
			AppFactory factory = TestContext.start(config(descriptor));
	...
	/** Constructor arguments for REMOTE type should throw illegal argument. */
	@Test(expected = IllegalArgumentException.class)
	public void getInstance_ConstructorArguments_RemoteType() throws Exception {
		String descriptor = "<product interface='js.core.test.AppFactoryUnitTest$Product' type='REMOTE' url='http://localhost/' />";
		AppFactory factory = TestContext.start(config(descriptor));
		factory.getInstance(Product.class, "John Doe");
	}

	/** Constructor arguments for SERVICE type should throw illegal argument. */
	@Test(expected = IllegalArgumentException.class)
	public void getInstance_ConstructorArguments_ServiceType() throws Exception {
		String descriptor = "<product interface='js.core.test.AppFactoryUnitTest$Product' type='SERVICE' />";
		AppFactory factory = TestContext.start(config(descriptor));
		factory.getInstance(Product.class, "John Doe");
	}

	/** Invalid constructor argument type should throw illegal argument. */
	@Test(expected = IllegalArgumentException.class)
	public void getInstance_ConstructorArguments_BadType() throws Exception {
		String descriptor = "<person class='js.core.test.AppFactoryUnitTest$Person' scope='LOCAL' />";
		AppFactory factory = TestContext.start(config(descriptor));
		factory.getInstance(Person.class, new Date());
	}

	/** Bad constructor arguments count should throw illegal argument. */
	@Test(expected = IllegalArgumentException.class)
	public void getInstance_ConstructorArguments_BadNumber() throws Exception {
		String descriptor = "<person class='js.core.test.AppFactoryUnitTest$Person' scope='LOCAL' />";
		AppFactory factory = TestContext.start(config(descriptor));
		factory.getInstance(Person.class, "John Doe", new Date());
	}
	...
	public void getInstance_ConstructorInvocationException() throws Exception {
		String descriptor = "<person class='js.core.test.AppFactoryUnitTest$ExceptionalObject' scope='LOCAL' />";
		AppFactory factory = TestContext.start(config(descriptor));
	...
	public void getInstance_ApplicationMultipleInterfaces() throws Exception {
		String descriptor = "" + //
				"<car class='js.core.test.AppFactoryUnitTest$Car'>" + //
				"	<interface name='js.core.test.AppFactoryUnitTest$Product' />" + //
				"	<interface name='js.core.test.AppFactoryUnitTest$Vehicle' />" + //
				"</car>";
		AppFactory factory = TestContext.start(config(descriptor));
	...
	public void getInstance_ThreadMultipleInterfaces() throws Exception {
		String descriptor = "" + //
				"<car class='js.core.test.AppFactoryUnitTest$Car' scope='THREAD'>" + //
				"	<interface name='js.core.test.AppFactoryUnitTest$Product' />" + //
				"	<interface name='js.core.test.AppFactoryUnitTest$Vehicle' />" + //
				"</car>";
		AppFactory factory = TestContext.start(config(descriptor));
	...
	public void getInstance_LocalMultipleInterfaces() throws Exception {
		String descriptor = "" + //
				"<car class='js.core.test.AppFactoryUnitTest$Car' scope='LOCAL'>" + //
				"	<interface name='js.core.test.AppFactoryUnitTest$Product' />" + //
				"	<interface name='js.core.test.AppFactoryUnitTest$Vehicle' />" + //
				"</car>";
		AppFactory factory = TestContext.start(config(descriptor));
	...
	public void getInstance_AccessViaImplementation() throws Exception {
		String descriptor = "" + //
				"<car class='js.core.test.AppFactoryUnitTest$Car'>" + //
				"	<interface name='js.core.test.AppFactoryUnitTest$Car' />" + //
				"	<interface name='js.core.test.AppFactoryUnitTest$Product' />" + //
				"	<interface name='js.core.test.AppFactoryUnitTest$Vehicle' />" + //
				"</car>";
		AppFactory factory = TestContext.start(config(descriptor));
	...
	public void getInstance_NotProvidedService() throws Exception {
		String descriptor = "<product interface='js.core.test.AppFactoryUnitTest$Vehicle' type='SERVICE' />";
		AppFactory factory = TestContext.start(config(descriptor));
	...
	public void getNamedInstance() throws Exception {
		String descriptor = "" + //
				"<audi class='js.core.test.AppFactoryUnitTest$Car' />" + //
				"<fiat class='js.core.test.AppFactoryUnitTest$Car' />";
		AppFactory factory = TestContext.start(config(descriptor));
	...
	public void getNamedInstance_InstanceFieldInject() throws Exception {
		...
		AppFactory factory = TestContext.start(config);
	...
	/** Constructor arguments for REMOTE type should throw illegal argument. */
	@Test(expected = IllegalArgumentException.class)
	public void getOptionalInstance_ConstructorArguments_RemoteType() throws Exception {
		String descriptor = "<product interface='js.core.test.AppFactoryUnitTest$Product' type='REMOTE' url='http://localhost/' />";
		AppFactory factory = TestContext.start(config(descriptor));
		factory.getOptionalInstance(Product.class, "John Doe");
	}

	/** Constructor arguments for SERVICE type should throw illegal argument. */
	@Test(expected = IllegalArgumentException.class)
	public void getOptionalInstance_ConstructorArguments_ServiceType() throws Exception {
		String descriptor = "<product interface='js.core.test.AppFactoryUnitTest$Product' type='SERVICE' />";
		AppFactory factory = TestContext.start(config(descriptor));
		factory.getOptionalInstance(Product.class, "John Doe");
	}
	...
	/** Invalid constructor argument type should throw illegal argument. */
	@Test(expected = IllegalArgumentException.class)
	public void getOptionalInstance_ConstructorArguments_BadType() throws Exception {
		String descriptor = "<person class='js.core.test.AppFactoryUnitTest$Person' scope='LOCAL' />";
		AppFactory factory = TestContext.start(config(descriptor));
		factory.getOptionalInstance(Person.class, new Date());
	}

	/** Bad constructor arguments count should throw illegal argument. */
	@Test(expected = IllegalArgumentException.class)
	public void getOptionalInstance_ConstructorArguments_BadNumber() throws Exception {
		String descriptor = "<person class='js.core.test.AppFactoryUnitTest$Person' scope='LOCAL' />";
		AppFactory factory = TestContext.start(config(descriptor));
		factory.getOptionalInstance(Person.class, "John Doe", new Date());
	}
