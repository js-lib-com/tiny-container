...
public class AppUnitTest {
	...
	public void postConstruct_Container() throws ConfigException {
		String descriptor = "" + //
				"<descriptor>" + //
				"	<managed-classes>" + //
				"		<app interface='js.core.App' class='js.core.test.AppUnitTest$MockApp' />" + //
				"		<app-context interface='js.core.AppContext' class='js.core.test.AppUnitTest$MockAppContext'  />" + //
				"	</managed-classes>" + //
				"	<app>" + //
				"	</app>" + //
				"</descriptor>";
