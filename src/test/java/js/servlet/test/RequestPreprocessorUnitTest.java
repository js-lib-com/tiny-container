...
public class RequestPreprocessorUnitTest {
	...
	public void doFilter_ExistingFile() throws IOException, ServletException {
		MockHttpServletRequest request = new MockHttpServletRequest("/app/src/main/java/js/servlet/RequestPreprocessor.java");
		MockHttpServletResponse response = new MockHttpServletResponse();
		MockFilterChain chain = new MockFilterChain();
		...
		assertEquals("/app/src/main/java/js/servlet/RequestPreprocessor.java", chain.requestURI);
	}
