 ...
 * handler, see {@link js.net.HttpRmiServlet}; usually a HTTP-RMI request uses <b>rmi</b> extension. HTTP-RMI can be used to connect 
 ...
 * If method execution fails {@link js.net.HttpRmiServlet} creates an exception transport instance, see {@link js.rmi.RemoteException}, and
 ...
 * global {@link js.core.Factory}, as in snippet below. The returned instance is in fact a Java Proxy that implements remote service interface
