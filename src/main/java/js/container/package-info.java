 ...
 * discussion about managed class configuration please see {@link js.container.ManagedClassSPI} description.
 * <pre>
 * &lt;managed-classes&gt;
 ...
 * There are two major types of managed classes: {@link js.container.InstanceType#POJO} and {@link js.container.InstanceType#PROXY}. Only container can 
 * benefit from all managed classes services, see list below. 
 * <p>
 * A managed class is not created with <code>new</code> operator; there is a {@link js.core.AppFactory factory} dedicated exactly for 
 * that. Every application has its own managed instances factory; there is also a master factory - see {@link js.core.Factory}, with 
 ...
 * <p>
 * Managed instances are created by managed instances {@link js.core.AppFactory factory} and comes in two flavors: managed POJOs and 
 ...
 * <li>{@link js.annotation.Inject Dependency} injection for fields and constructor parameters.
 ...
 * <ul>
 * <li>Authenticated remote access to {@link js.annotation.Remote remote} managed methods; authentication occurs at method invocation.
 * <li>Declarative {@link js.annotation.Asynchronous asynchronous} execution mode for long running logic, executed in separated thread.
 * <li>Method invocation listener. There are {@link js.container.Interceptor interceptors} for before, after and around method invocation.
 * <li>Method instrumentation. Uses {@link js.container.InvocationMeter} to monitor method invocations.
 * </ul>
 ...
 * </ul>
 * </ol>
 * Any managed method declared {@link js.annotation.Remote remote} can be invoked remotely via <a href="../rmi/package-summary.html#http-rmi">HTTP-RMI</a> 
