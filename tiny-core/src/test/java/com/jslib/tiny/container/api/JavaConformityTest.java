package com.jslib.tiny.container.api;
...
public class JavaConformityTest {
	...
	public void staticInitialization() throws Throwable {
		...
		Class<?> clsA = Class.forName("com.jslib.tiny.container.api.JavaConformityTest$TestClass", true, loader1);
		Class<?> clsB = Class.forName("com.jslib.tiny.container.api.JavaConformityTest$TestClass", true, loader2);
